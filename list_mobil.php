...
<div style="display:flex; align-items:center; gap:10px; padding:10px; background:#f5f5f5;">
  <img src="logo-ead.png" alt="Logo Showroom EAD" style="height:60px;">
  <h1 style="margin:0;">Showroom EAD</h1>
</div>
<hr>
